...
<html lang="en">
  ...
  <style>
      ...
      footer {
        ...
        .footer,
        .card {
            background-color: rgba(255, 255, 255, 0.9); /* Set a semi-transparent white background for better readability */
        }
  ...
  <div class="container-fluid">
    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item">
            <a class="btn btn-success" href="tambahBuku.php">Tambah Buku</a>
        </li>
    </ul>
</div>

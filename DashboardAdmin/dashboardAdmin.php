  ...
  <body>
    ...
    <nav class="navbar fixed-top bg-body-tertiary shadow-sm">
      <div class="container-fluid p-2">
        ...
        <ul class="navbar-nav">
        <li class="nav-item">
          <a class="btn btn-success" href="daftarpetugas/listpetugas.php">Daftar Petugas</a>
        </li>
      </ul>
        <div class="dropdown">
    ...
    <div class="mt-5 p-4">
      ...
      <div class="alert alert-success" role="alert">Selamat datang admin - <span class="fw-bold text-capitalize"><?php echo $_SESSION['admin']['nama_admin']; ?></span> di Dashboard Perpus</div>
      ...
      <div class="mt-4 p-3">
        ...
        <div class="cardImg">
         ...
         <!--<div class="cardImg">
           <a href="daftarpetugas/listpetugas.php">
           <img src="../assets/dashboardCardMember/denda.png" alt="daftar buku" style="max-width: 100%;" width="600px">
           </a>
         </div>-->
        </div>

  ...
  <body>
    ...
    <table class="table table-striped table-hover">
      ...
      <tr>
        ...
        <th class="bg-white text-dark">Judul buku</th>
        <th class="bg-white text-dark">Nisn</th>
        <th class="bg-white text-dark">Nama siswa</th>
        <th class="bg-white text-dark">Jurusan</th>
        <th class="bg-white text-dark">Nama admin</th>
        <th class="bg-white text-dark">Hari pengembalian</th>
        <th class="bg-white text-dark">Keterlambatan</th>
        <th class="bg-white text-dark">Denda</th>
      </tr>
      </thead>

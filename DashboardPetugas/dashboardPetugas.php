...
<h1 class="mt-5 fw-bold" style="color: white;">Dashboard - <span class="fs-4 text-white"> <?php echo $day. " ". $dayOfMonth." ". " ". $month. " ". $year; ?> </span></h1>
      ...
      <div class="alert alert-success" role="alert">Selamat datang Petugas - <span class="fw-bold text-capitalize"><?php echo $_SESSION['petugas']['nama_petugas']; ?></span> di Dashboard Perpus</div>
